...
left arm:
best offsets               :  ['4.712', '6.283', '7.854', '4.712', '7.854', '0.000']
best offsets function of pi: [3*np.pi/2, 4*np.pi/2, 5*np.pi/2, 3*np.pi/2, 5*np.pi/2, 0*np.pi/2 ]
gripper open (degrees)        17.114453125
gripper close (degrees)       -24.685546875


right arm:
best offsets               :  ['3.142', '1.571', '3.142', '6.283', '0.000', '3.142']
best offsets function of pi: [2*np.pi/2, 1*np.pi/2, 2*np.pi/2, 4*np.pi/2, 0*np.pi/2, 2*np.pi/2 ]
gripper open (degrees)        290.630078125
gripper close (degrees)       248.830078125
